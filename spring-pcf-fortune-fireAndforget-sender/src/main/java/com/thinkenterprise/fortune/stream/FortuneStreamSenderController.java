...
public class FortuneStreamSenderController {
	...
	public String fortune() {
		...
		if(fortuneOutputStream.fortuneOutput().send(MessageBuilder.withPayload(fortuneText).build()))
			return "send message with fortune string " + "fortuneText" + " over fire an forget communication pattern"; 
		else			
			return "send message with fortune string " + "fortuneText" + " error";  
